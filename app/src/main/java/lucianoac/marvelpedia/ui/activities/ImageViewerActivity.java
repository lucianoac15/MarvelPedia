...
import lucianoac.marvelpedia.helpers.ImgHelper;
...
public class ImageViewerActivity extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_download_photo:
                ImageViewerActivityPermissionsDispatcher.downloadAndShareWithPermissionCheck(this);
                break;
    ...
    private void download(boolean share) {
        ...
        new DownloadImageTask(this, storageDir, mId + ".png", share);
    }
            ...
            try {
                for (int i = 0; i < urls.length; i++) {
                    ...
                    if (url != null) {
                        ...
                        mSavedImage = ImgHelper.saveBitmapToPNG(bitmap, mDirectory, mFilename);

                        ImgHelper.addImageToGallery(mContext, mSavedImage.getAbsolutePath(), mFilename);
                    }
                }
